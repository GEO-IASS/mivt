function viewLayers2D(layers, mode, varargin)
% VIEWLAYERS2D view layers (as returned by patchlib.stackPatches)
%   viewLayers2D(layers, 'discrete', patchSize) see each layer in a separate subplot
%
...
% Contact: adalca@csail.mit.edu
    ...
    switch mode
        case 'discrete'
            ...
            [~, nElems] = patchlib.view.patches2D(v, volSize);
