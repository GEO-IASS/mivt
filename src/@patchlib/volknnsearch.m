...
%       dimentionality as src. patchSize is the size of the patches.
%       patches is a [M x V x K] array, with M being the number of patches, V the number of voxels
%       in a patch, and K from kNN. 
%
%   patches = volknnsearch(src, refs, patchSize, patchOverlap) allows the specification of a
%       patchOverlap amount or kind for src. See patchlib.overlapkind for more information. 
%       Default is the default used in patchlib.vol2lib.
%
...
% Contact: adalca@csail.mit.edu
    ...
    % source library
    srclib = patchlib.vol2lib(src, patchSize, srcoverlap{:});
