function [nPatches, newVolSize, overlap] = patchcount(volSize, patchSize, varargin)
% PATCHCOUNT number of patches that fit into a volume
%   nPatches = patchcount(volSize, patchSize) compute the number of patches that fit
...
%
%	nPatches = patchcount(volSize, patchSize, patchOverlap) The volume will be cropped to
