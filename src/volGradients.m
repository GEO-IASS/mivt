...
% outputType should be 'cell' or 'matrix'. If matrix, it will be numel(Vol) x nDims
%
% TODO: note that, for some reason, sometimes 0 gradients don't end up being 0. Perhaps it has
